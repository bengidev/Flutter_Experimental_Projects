...
class _TextStyles {
  ...
  final titleFont = GoogleFonts.marcellus();
  final contentFont = GoogleFonts.montserrat();
  ...
  late final TextStyle h4Bold = _createFont(titleFont,
      sizePx: 21, heightPx: 23, spacingPc: 5, weight: FontWeight.w600);

  late final TextStyle title1 =
      _createFont(titleFont, sizePx: 16, heightPx: 26, spacingPc: 5);
  late final TextStyle title1Bold = _createFont(titleFont,
      sizePx: 16, heightPx: 26, spacingPc: 5, weight: FontWeight.w600);
  late final TextStyle title2 =
      _createFont(titleFont, sizePx: 14, heightPx: 16.38);
  late final TextStyle title2Bold = _createFont(titleFont,
      sizePx: 14, heightPx: 16.38, weight: FontWeight.w600);

  late final TextStyle body1 =
      _createFont(contentFont, sizePx: 20, heightPx: 32);
  late final TextStyle body1Bold = _createFont(contentFont,
      sizePx: 20, heightPx: 32, weight: FontWeight.w600);

  late final TextStyle body2 =
      _createFont(contentFont, sizePx: 19, heightPx: 30.5);
  late final TextStyle body2Bold = _createFont(contentFont,
      sizePx: 19, heightPx: 30.5, weight: FontWeight.w600);

  late final TextStyle body3 =
      _createFont(contentFont, sizePx: 18, heightPx: 29);
  late final TextStyle body3Bold = _createFont(contentFont,
      sizePx: 18, heightPx: 29, weight: FontWeight.w600);

  late final TextStyle body4 =
      _createFont(contentFont, sizePx: 17, heightPx: 27.5);
  late final TextStyle body4Bold = _createFont(contentFont,
      sizePx: 17, heightPx: 27.5, weight: FontWeight.w600);

  late final TextStyle body5 =
      _createFont(contentFont, sizePx: 16, heightPx: 26);
  late final TextStyle body5Bold = _createFont(contentFont,
  ...
  late final TextStyle quote1 = _createFont(contentFont,
      sizePx: 32, heightPx: 40, weight: FontWeight.w600, spacingPc: -3);
  late final TextStyle quote2 = _createFont(contentFont,
      sizePx: 21, heightPx: 32, weight: FontWeight.w400);
  ...
  late final TextStyle button = _createFont(contentFont,
      sizePx: 14, weight: FontWeight.w600, spacingPc: 2, heightPx: 14);
