...
void main() {
  ...
  late GetRandomNumberTriviaCase getRandomNumberTriviaCase;

  setUp(() {
    mockINumberTriviaRepository = MockINumberTriviaRepository();
    getRandomNumberTriviaCase =
        GetRandomNumberTriviaCase(repository: mockINumberTriviaRepository);
  });
  ...
  void setUpLeftServerFailure() {
    when(
      () => mockINumberTriviaRepository.getRandomNumberTrivia(),
  ...
  test(
    'Given the parameter of getRandomNumberTriviaCase, '
    ...
    () async {
      ...
      /// ACT
      final result = await getRandomNumberTriviaCase(EmptyParams());
